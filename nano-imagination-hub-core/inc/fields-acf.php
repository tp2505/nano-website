		...
		array(
			...
			'fields'     => array(
				...
				array(
					...
					'filters'       => array( 'search' ),
					'return_format' => 'id',
					'instructions'  => 'The people the work is by — credited by name beneath the subtitle. Leave empty to use the linked event’s authors. Everyone else involved goes in the People field in the details box.',
				),
			),
		)
	);
		...
		array(
			...
			'fields'     => array(
				...
				array(
					...
					'filters'       => array( 'search' ),
					'return_format' => 'id',
					'instructions'  => 'The people the work is by — the speaker giving a talk, the artists in a residency. Credited by name beneath the subtitle. Everyone else involved goes in the People field in the details box below.',
				),
			),
		)
	);
		...
		array(
			...
			'fields'     => array_merge(
				...
				array(
					...
					'name'          => 'nano_ta',
					'type'          => 'text',
					'instructions'  => 'Optional. One or more names, plain text — TAs don’t get People pages.',
				),
				array(
